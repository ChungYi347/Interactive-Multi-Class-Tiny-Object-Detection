...
from mmdet.apis.runner import ValRunner as Runner
from mmcv.parallel import MMDataParallel, MMDistributedDataParallel

from mmdet import datasets
from mmdet.core import (DistOptimizerHook, DistEvalmAPHook, PascalDistEvalmAPHook,
                        CocoDistEvalRecallHook, CocoDistEvalmAPHook)
from mmdet.datasets import build_dataloader, DOTA2Dataset_v2_Tiny
...
def _dist_train(model, datasets, cfg, validate=False):
    ...
    runner = Runner(model, batch_processor, optimizer, cfg.work_dir,
                    cfg.log_level, val_interval=cfg.val_interval)
    # register hooks
    ...
    if validate:
        ...
        if isinstance(model.module, RPN):
            ...
            if 'Tiny' in val_dataset_cfg.type:
                runner.register_hook(PascalDistEvalmAPHook(val_dataset_cfg, val_interval))
            else:
